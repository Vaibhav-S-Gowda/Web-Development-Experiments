...
function addTwoArrays(){
	var studentList = ["Moanoj", "Aatishey"];
	var girlsList = ["Srilakshmi", "Meghana", "Madhuri", "Anjana Kumari"];
	var finalList = studentList.concat(girlsList);

	document.write(studentList.concat(girlsList));
}
